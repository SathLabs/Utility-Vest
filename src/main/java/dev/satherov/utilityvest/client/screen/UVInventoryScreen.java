...
public class UVInventoryScreen extends AbstractContainerScreen<UVInventoryMenu> implements MenuAccess<UVInventoryMenu> {
    ...
    protected void renderBg(GuiGraphics guiGraphics, float partialTick, int mouseX, int mouseY) {
        ...
        guiGraphics.blit(UVInventoryScreen.CONTAINER_BACKGROUND, i, j, 0, 0, this.imageWidth, 17);
        for (int row = 0; row < this.containerRows; row++) {
            guiGraphics.blit(UVInventoryScreen.CONTAINER_BACKGROUND, i, j + 17 + row * 18, 0, 17, this.imageWidth, 18);
        }
